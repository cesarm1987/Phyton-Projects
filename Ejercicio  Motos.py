...
def factura(Marca,PorcDesc,Inicial,DescMonto):
    Nombre = input("Indique el nombre del cliente ")
    print("\t********FACTURA PROFORMA********")
    print("\nNombre del cliente:\t", Nombre)
    print("Marca de moto:\t\t", Marca)
    print("Precio inicial:\t\t",Inicial)
    print("Descuento:\t\t",(PorcDesc * 100),"%")
    print("Monto descuento:\t",DescMonto)
    print("Precio final:\t\t",(Inicial - DescMonto))

def descuento(Moto,Porc,Costo):
    MontoDesc = Costo*Porc
